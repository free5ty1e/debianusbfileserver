...
sudo apt-get install -y git curl samba samba-client cifs-utils ftp curlftpfs dialog ntfs-3g cowsay pv bc expect openssl parted gdisk rsync e2fsprogs smartmontools hddtemp hdparm p7zip-full
