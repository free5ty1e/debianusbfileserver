...
#1-pass, 1080p, veryslow, mp3 audio defaults
ffmpeg -i "$1" -vcodec libx265 -crf 28 -preset veryslow -acodec libmp3lame -vf 'scale=1920:1920:force_original_aspect_ratio=decrease' "$2"
