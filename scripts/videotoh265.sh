...
if [ -z "$5" ] ; then
    ...
    ffmpeg -i "$1" -vcodec libx265 -crf "$VIDEO_COMPRESSION_RATE_FACTOR" -preset veryslow -x265-params pass=2:vbv-maxrate=1000:vbv-bufsize=2000 -c:a aac -b:a 128k -vf "$SCALE_PARAMETER" "$2"
fi
